...
public class ciclodiaynoche : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        hora = Mathf.Floor(tiempoDelDia * 24);
        diaTXT.text = diasContador.ToString();
        horaTXT.text = hora.ToString();
        UpdatepositionDayNightCycle();
    ...
    private void UpdatepositionDayNightCycle(){
        // Actualiza la rotación de la luz (sol o luna) para simular el ciclo día-noche.
